...
sites_per_miR$group <- ifelse(sites_per_miR$sites == 0, "No TDMD-like sites", "≥1 TDMD-like site")
...
gpie <- ggpie::ggpie(data = sites_per_miR,
      ...
      title = "Predicted TDMD-like site enrichment\n"
      ) +
