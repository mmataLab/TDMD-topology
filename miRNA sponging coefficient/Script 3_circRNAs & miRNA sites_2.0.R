...
most_sponging_circRNAs$Effective_sites <- most_sponging_circRNAs$Total_Sites_Per_circ * ((most_sponging_circRNAs$H9_JReads + most_sponging_circRNAs$FB_JReads)/2)
...
write_csv(most_sponging_circRNAs, "./miRNA sponging coefficient/Results/circRNAs effective sites_2.0.csv")
