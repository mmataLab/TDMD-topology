...
miRNA_circRNA_Overlaps <- read_csv("./miRNA sponging coefficient/Results/miR_Cir_interactions_fulltable_2.0.csv")
...
gor <- ggbarplot(table_geneFeat_sp, x = "Var2", y = "Percentage", fill = "Var1", xlab = "") +
